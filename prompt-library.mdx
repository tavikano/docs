...
```typescript
// Example prompt template
const textToSFXPrompt = `
Generate sound effects based on:
...
```typescript
// Example prompt template
const timedTranscriptionPrompt = `
...
```typescript
// Example prompt template
const realtimeTranslationPrompt = `
