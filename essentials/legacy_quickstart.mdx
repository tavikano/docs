...
3. Enter the newly created private thread
   - Thread names are random.
   - Only the user can see the thread creation message(ephemeral threads)
...
- '/transcribe': Convert audio to text and captions
...
- Minimum image size: 320x320
- Maximum image size: 2816x1536
- Maximum Image Resolution: 4.19 million pixels (that is, 2048x2048, 2816x1536)
