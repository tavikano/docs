...
/text-to-speech   # Generate spoken audio from text files
/transcribe       # Generate Speech-to-Text Transcriptions and Captions
```
...
3. Upload your media (images, video, etc.)
